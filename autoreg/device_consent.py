...
if not PROXY:
    raise SystemExit('missing CLIPROXY env var (residential proxy IP)')
...
for line in lines:
    ...
    try:
        ...
        if btn1:
            ...
            print(f'  Step1: Continue clicked')
            time.sleep(5)
